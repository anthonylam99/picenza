                        ...
                        <div class="main-content row">
                            <div class="product-main-item col-4">
                                <div class="product-item">
                                    <a href="">
                                        <div class="image">
                                            <img src="{{asset('images/product/product_4.png')}}" alt="">
                                        </div>
                                        <div class="description text-center">
                                            <div class="name">
                                                <h5>Bình lọc tổng hikarix SH-1500</h5>
                                            </div>
                                            <div class="price">
                                                <div class="sale">1.000.000đ</div>
                                                <div class="unsale">1.200.000đ</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
