                ...
                <form action="{{route('admin.project.add.post')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <input type="text" name="title" id="title" class="form-control col-sm-9" value=""
                                   placeholder="Nhập tiêu đề dự án..." required>
                        </div>
                        {{--                        <div class="form-group row">--}}
                        ...
                        <div class="form-group">
                            <div class="form-group row" id="productFeature" style="margin-left: 0">
                                <div class="custom-control custom-checkbox col-4">
                                    <input name="tagged" class="custom-control-input" type="checkbox" id="status"
                                    >
