...
@section('content')
    <div class="col-3">
        <button style="margin-bottom: 10px" type="button" class="btn btn-success">
            <a style="color: #FFFFFF;" href="{{route('admin.project.category.add')}}">
                Thêm mới
            </a>
        </button>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="form-search float-right">
                    <form style="margin-bottom: 0" class="form-group" action="{{route('admin.project.category.list')}}">
                       <input  class="form-control" type="text" name="s" value="" placeholder="Tìm kiếm chuyên mục....">
                    </form>
                </div>
            </div>
            <!-- /.card-header -->
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-info">
                                        <a target="_blank" style="color: #FFFFFF" href="{{ route('home.project.news', ['slug' => $value->slug]) }}">
                                ...
                                <td class=" text-center">
                                    <button class="btn btn-info">
                                        <a style="color: #FFFFFF" href="{{ route('admin.project.category.edit', ['id' => $value->id]) }}">
                                ...
                                <td class="text-center">
                                    <button class="btn btn-danger">
                                        <a style="color: #FFFFFF" href="{{ route('admin.project.category.del', ['id' => $value->id]) }}">
