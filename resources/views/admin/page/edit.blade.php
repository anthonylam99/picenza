                                                ...
                                                @foreach($tag as $value)
                                                    ...
                                                    <div class="col-3 img-boxbanner" id="label-imagebanner{{$i}}"
                                                        ...
                                                        <label for="image-inputbanner{{$i}}" class="image-upload"><i
                                                            ...
                                                            id="image-inputbanner{{$i}}" type="file"
                                                            name="imagebanner{{$i}}"
                                                            data-photo="1">
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="body-card-imagedes row" id="card-imagedes">

                                                <?php $i = 0; ?>
                                                @foreach($tag as $value)
                                                    <?php $i++; ?>
                                                    <div class="col-3 img-boxdes" id="label-imagedes{{$i}}"
                                                         data-photo="{{$i}}">
                                                        <div
                                                            style="height: 100px; border: 2px dashed #cccccc; margin-bottom: 10px;"
                                                            id="image-previewdes{{$i}}" class="show-img">
                                                            <img src="{{asset($value->image_path)}}">
                                                        </div>
                                                        <label for="image-inputdes{{$i}}" class="image-upload"><i
                                                                class="fas fa-upload"></i>Chọn ảnh</label><input
                                                            style="display: none"
                                                            onchange="previewImageCustom({{$i}},  'banner' )"
                                                            id="image-inputdes{{$i}}" type="file" name="imagedes{{$i}}"
                                                            data-photo="1">
                                                        <button type="button" class="btn-danger btn-deleteimg"
                                                                onclick="removeImageCustom({{$i}},  'des', {{$value->id}} )">
                                                            Xóa ảnh
                                                        </button>
                                                    </div>
                                                @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="body-card-imagediscovery row" id="card-imagediscovery">
                                                   ...
                                                   @foreach($tag as $value)
                                                       ...
                                                       <?php $i++; ?>
                                                        <div class="col-3 img-boxdiscovery" id="label-imagediscovery{{$i}}" data-photo="1">
                                                            ...
                                                            <input
                                                                ...
                                                                name="titlediscovery{{$i}}" value="{{$value->title}}" placeholder="Nhập tiêu đề..">
                                                            <input
                                                                style="margin-bottom: 3px" class="form-control" type="text"
                                                            ...
                                                            <input style="display: none"
                                                                   ...
                                                                   data-photo="{{$i}}">
                                                            <button type="button" class="btn-danger btn-deleteimg"
                                                                    onclick="removeImageCustom({{$i}},  'discovery', {{$value->id}} )">Xóa ảnh
                                                            </button>
                                                        </div>
                                                   @endforeach
                                                </div>
                                                <button onclick="addImageBox('discovery')" type="button" class="btn-add-custom"
                                                    ...
                                                    @foreach($tag as $value)
                                                        ...
                                                        <div class="col-3 img-boxbrand" id="label-imagebrand{{$i}}"
                                                            ...
                                                            <label for="image-inputbrand{{$i}}" class="image-upload"><i
                                                                ...
                                                                style="display: none"
                                                                onchange="previewImageCustom({{$i}},  'banner' )"
                                                                id="image-inputbrand{{$i}}" type="file" name="imagebrand{{$i}}"
                                                                data-photo="1">
                                                            <button type="button" class="btn-danger btn-deleteimg"
